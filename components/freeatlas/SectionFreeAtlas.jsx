...
//               email tutorials. <br /> Subscribe to and find out how digestion
//               works and where to start making dietary changes.
//             </p>
...
//                 <p>
//                   Discover how stress impacts your gut health, including its
//                   impact on microbiome diversity and digestion.
//                 </p>
//               </div>
...
//                 <p>
//                   We are what we eat. Find out how to eat happily and healthily
//                 </p>
//               </div>
//               <div className={style.freeatlas__card3}>
//                 <h2>
//                   EATTHE <br />
//                   <span id={style.rainbov}>RAINBOW</span>
//                 </h2>
...
//                   Thesecret
//                   <br />
//                   life of gut bacteria
//                 </h2>

//                 <span>PDF ebook</span>
//                 <p>
//                   Learn how to make your gut bacteria happier and how to take
...
function SectionFreeAtlas() {
  return (
    <section className={style.freeatlas}>
      <div className={style.freeatlas__container}>
        <div className={style.freeatlas__top}>
          <div className={style.freeatlas__top__text}>
            <h1 className={style.freeatlas__title}>
              Free
              <span>Atlas courses</span>
            </h1>
          ...
          <div className={style.freeatlas__top__button}>
            <button className={style.freeatlas__button}> All Courses</button>
          </div>
        </div>
        <img
        ...
        {/* </div> */}
        <div className={style.freeatlas__cards}>
          <div className={style.freeatlas__card}>
            <div className={style.freeatlas__card__container}>
              <h2>
                Mindful <br /> Course
              </h2>
